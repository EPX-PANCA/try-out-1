    ...
    static async saveProduct(req, res) {
      ...
      static async updateProduct(req, res) {
        ...
        try {
          ...
          response.message = `sukses update data product in dengan id : ${id}`;
      ...
      static async getProduct(req, res) {
        ...
        try {
          if (!userdetail) throw new Error("Product in not found")
      ...
      static async deleteProduct(req, res) {
        ...
        try {
          ...
          response.message = `sukses hapus data product in dengan id : ${id}`;
          response.data = [];
          res.status(201).json(response);
        } catch (error) {
          response.status = false;
